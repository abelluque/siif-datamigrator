...
@NamedQuery(name="AviEvento_MPFUsers.findAll", query="SELECT a FROM AviEvento_MPFUsers a")
public class AviEvento_MPFUsers implements Serializable {
