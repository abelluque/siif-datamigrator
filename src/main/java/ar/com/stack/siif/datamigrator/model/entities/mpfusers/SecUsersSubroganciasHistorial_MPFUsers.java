...
@NamedQuery(name="SecUsersSubroganciasHistorial_MPFUsers.findAll", query="SELECT s FROM SecUsersSubroganciasHistorial_MPFUsers s")
public class SecUsersSubroganciasHistorial_MPFUsers implements Serializable {
	...
	public SecUsersSubroganciasHistorial_MPFUsers() {
	}
