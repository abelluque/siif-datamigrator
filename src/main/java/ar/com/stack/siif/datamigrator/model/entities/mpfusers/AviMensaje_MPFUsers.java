...
@NamedQuery(name="AviMensaje_MPFUsers.findAll", query="SELECT a FROM AviMensaje_MPFUsers a")
public class AviMensaje_MPFUsers implements Serializable {
