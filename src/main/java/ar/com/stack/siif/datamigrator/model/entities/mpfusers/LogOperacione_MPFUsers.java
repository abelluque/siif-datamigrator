...
@NamedQuery(name="LogOperacione_MPFUsers.findAll", query="SELECT l FROM LogOperacione_MPFUsers l")
public class LogOperacione_MPFUsers implements Serializable {
