...
@NamedQuery(name="SecParameter_MPFUsers.findAll", query="SELECT s FROM SecParameter_MPFUsers s")
public class SecParameter_MPFUsers implements Serializable {
