...
@NamedQuery(name="SecUsersSubrogancia_MPFUsers.findAll", query="SELECT s FROM SecUsersSubrogancia_MPFUsers s")
public class SecUsersSubrogancia_MPFUsers implements Serializable {
	...
	public SecUsersSubrogancia_MPFUsers() {
	}
