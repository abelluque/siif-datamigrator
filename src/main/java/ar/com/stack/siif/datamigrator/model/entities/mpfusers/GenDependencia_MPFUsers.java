...
@NamedQuery(name="GenDependencia_MPFUsers.findAll", query="SELECT g FROM GenDependencia_MPFUsers g")
public class GenDependencia_MPFUsers implements Serializable {
	...
	public GenDependencia_MPFUsers() {
	}
