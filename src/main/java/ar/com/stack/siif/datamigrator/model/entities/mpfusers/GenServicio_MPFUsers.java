...
@NamedQuery(name="GenServicio_MPFUsers.findAll", query="SELECT g FROM GenServicio_MPFUsers g")
public class GenServicio_MPFUsers implements Serializable {
