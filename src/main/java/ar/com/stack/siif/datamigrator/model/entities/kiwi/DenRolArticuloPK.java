...
/**
 * The primary key class for the den_rol_articulo database table.
 * 
 */
@Embeddable
public class DenRolArticuloPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DenRolArticuloPK)) {
			return false;
		}
		DenRolArticuloPK castOther = (DenRolArticuloPK)other;
		return 
