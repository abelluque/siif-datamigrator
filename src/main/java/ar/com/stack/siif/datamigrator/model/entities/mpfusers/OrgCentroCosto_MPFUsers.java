...
@NamedQuery(name="OrgCentroCosto_MPFUsers.findAll", query="SELECT o FROM OrgCentroCosto_MPFUsers o")
public class OrgCentroCosto_MPFUsers implements Serializable {
	...
	public OrgCentroCosto_MPFUsers() {
	}
