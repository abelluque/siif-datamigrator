...
@NamedQuery(name="LogProceso_MPFUsers.findAll", query="SELECT l FROM LogProceso_MPFUsers l")
public class LogProceso_MPFUsers implements Serializable {
