...
/**
 * The primary key class for the gen_turnos_juzgados database table.
 * 
 */
@Embeddable
public class GenTurnosJuzgadoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof GenTurnosJuzgadoPK)) {
			return false;
		}
		GenTurnosJuzgadoPK castOther = (GenTurnosJuzgadoPK)other;
		return 
