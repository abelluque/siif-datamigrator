...
@NamedQuery(name="SecSequence_MPFUsers.findAll", query="SELECT s FROM SecSequence_MPFUsers s")
public class SecSequence_MPFUsers implements Serializable {
