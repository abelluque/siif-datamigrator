...
@NamedQuery(name="AviEntrante_MPFUsers.findAll", query="SELECT a FROM AviEntrante_MPFUsers a")
public class AviEntrante_MPFUsers implements Serializable {
