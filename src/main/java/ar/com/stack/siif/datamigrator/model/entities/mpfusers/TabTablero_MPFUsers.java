...
@NamedQuery(name="TabTablero_MPFUsers.findAll", query="SELECT t FROM TabTablero_MPFUsers t")
public class TabTablero_MPFUsers implements Serializable {
