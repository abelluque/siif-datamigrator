...
@Entity
@Table(name="sec_acl")
@NamedQuery(name="SecAcl_MPFUsers.findAll", query="SELECT s FROM SecAcl_MPFUsers s")
public class SecAcl_MPFUsers implements Serializable {
