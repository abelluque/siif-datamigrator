...
@NamedQuery(name="DocDocument_MPFUsers.findAll", query="SELECT d FROM DocDocument_MPFUsers d")
public class DocDocument_MPFUsers implements Serializable {
