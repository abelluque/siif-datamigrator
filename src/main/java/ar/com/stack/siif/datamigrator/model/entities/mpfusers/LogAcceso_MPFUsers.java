...
@NamedQuery(name="LogAcceso_MPFUsers.findAll", query="SELECT l FROM LogAcceso_MPFUsers l")
public class LogAcceso_MPFUsers implements Serializable {
